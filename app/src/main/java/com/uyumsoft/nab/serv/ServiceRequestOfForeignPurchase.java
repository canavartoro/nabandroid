...
public class ServiceRequestOfForeignPurchase extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public ForeignPurchase FilterObject = new ForeignPurchase();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new ForeignPurchase().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new ForeignPurchase(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfForeignPurchase", this.getClass());
                   new UserInformation().register(envelope); 
           new ForeignPurchase().register(envelope); 
