...
public class ServiceResponseOfDomesticPurchaseStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public DomesticPurchaseStockDetail Item = new DomesticPurchaseStockDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new DomesticPurchaseStockDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              if(itemCount > 0){ 
                  Item = new DomesticPurchaseStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfDomesticPurchaseStockDetail", this.getClass());
