...
public class ServiceRequestOfDomesticPurchase extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public DomesticPurchase FilterObject = new DomesticPurchase();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new DomesticPurchase().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new DomesticPurchase(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfDomesticPurchase", this.getClass());
                   new UserInformation().register(envelope); 
           new DomesticPurchase().register(envelope); 
