...
public class ServiceRequestOfStockAction extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public StockAction FilterObject = new StockAction();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new StockAction().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfStockAction", this.getClass());
                   new UserInformation().register(envelope); 
           new StockAction().register(envelope); 
