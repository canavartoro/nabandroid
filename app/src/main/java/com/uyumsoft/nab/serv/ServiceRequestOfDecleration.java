...
public class ServiceRequestOfDecleration extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public Decleration FilterObject = new Decleration();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new Decleration().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfDecleration", this.getClass());
