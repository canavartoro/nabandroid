...
public class ServiceResponseOfDispatchOrderStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public DispatchOrderStockDetail Item = new DispatchOrderStockDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new DispatchOrderStockDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              if(itemCount > 0){ 
                  Item = new DispatchOrderStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfDispatchOrderStockDetail", this.getClass());
