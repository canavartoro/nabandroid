...
public class ServiceResponseOfListOfFile extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfFile Item = new ArrayOfFile();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfFile().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfFile", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfFile().register(envelope); 
