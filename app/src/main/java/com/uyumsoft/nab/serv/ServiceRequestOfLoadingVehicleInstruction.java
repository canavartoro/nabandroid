...
public class ServiceRequestOfLoadingVehicleInstruction extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public LoadingVehicleInstruction FilterObject = new LoadingVehicleInstruction();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new LoadingVehicleInstruction().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new LoadingVehicleInstruction(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfLoadingVehicleInstruction", this.getClass());
