...
public class ServiceResponseOfListOfDispatchOrderStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfDispatchOrderStockDetail Item = new ArrayOfDispatchOrderStockDetail();  //array
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  Item = new ArrayOfDispatchOrderStockDetail(); 
                  SoapObject prp = (SoapObject)value; 
                  int itemCount = prp.getPropertyCount(); 
                  for(int loop=0;loop<itemCount;loop++){ 
                  if(prp.getProperty(loop) instanceof SoapObject){ 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfDispatchOrderStockDetail", this.getClass());
