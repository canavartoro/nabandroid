...
public class ServiceRequestOfFile extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public File FilterObject = new File();
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfFile", this.getClass());
                   new UserInformation().register(envelope); 
           new File().register(envelope); 
