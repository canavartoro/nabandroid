...
public class ServiceRequestOfUser extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public User FilterObject = new User();
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfUser", this.getClass());
                   new UserInformation().register(envelope); 
           new User().register(envelope); 
