...
public class ServiceResponseOfForeignPurchaseStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ForeignPurchaseStockDetail Item = new ForeignPurchaseStockDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ForeignPurchaseStockDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              if(itemCount > 0){ 
                  Item = new ForeignPurchaseStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfForeignPurchaseStockDetail", this.getClass());
