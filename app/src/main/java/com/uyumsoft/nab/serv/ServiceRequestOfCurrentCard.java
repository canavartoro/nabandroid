...
public class ServiceRequestOfCurrentCard extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public CurrentCard FilterObject = new CurrentCard();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new CurrentCard().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfCurrentCard", this.getClass());
