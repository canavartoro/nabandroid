...
public class ServiceResponseOfListOfEntranceFromStoreWarehouseStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfEntranceFromStoreWarehouseStockDetail Item = new ArrayOfEntranceFromStoreWarehouseStockDetail();  //array
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  Item = new ArrayOfEntranceFromStoreWarehouseStockDetail(); 
                  SoapObject prp = (SoapObject)value; 
                  int itemCount = prp.getPropertyCount(); 
                  for(int loop=0;loop<itemCount;loop++){ 
                  if(prp.getProperty(loop) instanceof SoapObject){ 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfEntranceFromStoreWarehouseStockDetail", this.getClass());
