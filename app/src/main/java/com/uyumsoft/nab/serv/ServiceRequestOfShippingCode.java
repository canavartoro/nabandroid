...
public class ServiceRequestOfShippingCode extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public ShippingCode FilterObject = new ShippingCode();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new ShippingCode().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfShippingCode", this.getClass());
