...
public class ServiceRequestOfDispatchOrder extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public DispatchOrder FilterObject = new DispatchOrder();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new DispatchOrder().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new DispatchOrder(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfDispatchOrder", this.getClass());
