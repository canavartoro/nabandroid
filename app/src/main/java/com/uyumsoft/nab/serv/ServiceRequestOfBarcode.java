...
public class ServiceRequestOfBarcode extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public Barcode FilterObject = new Barcode();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new Barcode().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfBarcode", this.getClass());
                   new UserInformation().register(envelope); 
           new Barcode().register(envelope); 
