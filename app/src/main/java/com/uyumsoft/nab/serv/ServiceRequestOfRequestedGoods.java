...
public class ServiceRequestOfRequestedGoods extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public RequestedGoods FilterObject = new RequestedGoods();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new RequestedGoods().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new RequestedGoods(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfRequestedGoods", this.getClass());
