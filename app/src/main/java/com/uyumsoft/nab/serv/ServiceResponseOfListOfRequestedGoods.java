...
public class ServiceResponseOfListOfRequestedGoods extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfRequestedGoods Item = new ArrayOfRequestedGoods();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfRequestedGoods().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  Item = new ArrayOfRequestedGoods(); 
                  SoapObject prp = (SoapObject)value; 
                  int itemCount = prp.getPropertyCount(); 
                  for(int loop=0;loop<itemCount;loop++){ 
                  if(prp.getProperty(loop) instanceof SoapObject){ 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfRequestedGoods", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfRequestedGoods().register(envelope); 
