...
public class ServiceResponseOfListOfDispatchOrder extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfDispatchOrder Item = new ArrayOfDispatchOrder();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfDispatchOrder().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfDispatchOrder", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfDispatchOrder().register(envelope); 
