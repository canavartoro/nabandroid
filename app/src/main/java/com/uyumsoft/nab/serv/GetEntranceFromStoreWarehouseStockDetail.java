...
public class GetEntranceFromStoreWarehouseStockDetail extends BaseObject {

    private static final String METHOD_NAME = "GetEntranceFromStoreWarehouseStockDetail";
