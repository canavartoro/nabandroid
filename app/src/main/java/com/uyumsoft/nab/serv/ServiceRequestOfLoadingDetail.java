...
public class ServiceRequestOfLoadingDetail extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public LoadingDetail FilterObject = new LoadingDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new LoadingDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new LoadingDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfLoadingDetail", this.getClass());
                   new UserInformation().register(envelope); 
           new LoadingDetail().register(envelope); 
