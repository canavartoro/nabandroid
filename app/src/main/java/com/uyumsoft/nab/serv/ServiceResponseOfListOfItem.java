...
public class ServiceResponseOfListOfItem extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfItem Item = new ArrayOfItem();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfItem().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfItem", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfItem().register(envelope); 
