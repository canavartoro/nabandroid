...
public class ServiceRequestOfGoodsRequestDispatch extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public GoodsRequestDispatch FilterObject = new GoodsRequestDispatch();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new GoodsRequestDispatch().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new GoodsRequestDispatch(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfGoodsRequestDispatch", this.getClass());
                   new UserInformation().register(envelope); 
           new GoodsRequestDispatch().register(envelope); 
