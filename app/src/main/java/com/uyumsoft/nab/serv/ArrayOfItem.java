...
public class ArrayOfItem extends Vector<Item> implements KvmSerializable {
    ...
    /*public void register(SoapSerializationEnvelope envelope) {
        envelope.addMapping(n1, "ArrayOfItem", Item.class.getClass());
