...
public class ServiceRequestOfGoodsRequest extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public GoodsRequest FilterObject = new GoodsRequest();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new GoodsRequest().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfGoodsRequest", this.getClass());
