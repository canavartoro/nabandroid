...
public class ServiceResponseOfListOfGoodsRequestDispatchStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfGoodsRequestDispatchStockDetail Item = new ArrayOfGoodsRequestDispatchStockDetail();  //array
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  Item = new ArrayOfGoodsRequestDispatchStockDetail(); 
                  SoapObject prp = (SoapObject)value; 
                  int itemCount = prp.getPropertyCount(); 
                  for(int loop=0;loop<itemCount;loop++){ 
                  if(prp.getProperty(loop) instanceof SoapObject){ 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfGoodsRequestDispatchStockDetail", this.getClass());
