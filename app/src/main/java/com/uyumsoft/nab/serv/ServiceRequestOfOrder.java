...
public class ServiceRequestOfOrder extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public Order FilterObject = new Order();
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfOrder", this.getClass());
