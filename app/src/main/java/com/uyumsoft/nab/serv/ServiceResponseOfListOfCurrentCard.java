...
public class ServiceResponseOfListOfCurrentCard extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfCurrentCard Item = new ArrayOfCurrentCard();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfCurrentCard().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfCurrentCard", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfCurrentCard().register(envelope); 
