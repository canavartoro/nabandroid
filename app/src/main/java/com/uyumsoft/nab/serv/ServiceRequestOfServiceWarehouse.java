...
public class ServiceRequestOfServiceWarehouse extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public ServiceWarehouse FilterObject = new ServiceWarehouse();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new ServiceWarehouse().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new ServiceWarehouse(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfServiceWarehouse", this.getClass());
                   new UserInformation().register(envelope); 
           new ServiceWarehouse().register(envelope); 
