...
public class ServiceResponseOfListOfDecleration extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfDecleration Item = new ArrayOfDecleration();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfDecleration().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  Item = new ArrayOfDecleration(); 
                  SoapObject prp = (SoapObject)value; 
                  int itemCount = prp.getPropertyCount(); 
                  for(int loop=0;loop<itemCount;loop++){ 
                  if(prp.getProperty(loop) instanceof SoapObject){ 
                  SoapObject pi = (SoapObject)prp.getProperty(loop); 
                      Decleration item = new Decleration(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfDecleration", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfDecleration().register(envelope); 
