...
public class ArrayOfFile extends Vector<File> implements KvmSerializable {
    ...
    /*public void register(SoapSerializationEnvelope envelope) {
        envelope.addMapping(n1, "ArrayOfFile", File.class.getClass());
