...
public class ServiceResponseOfEntranceFromStoreWarehouseStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public EntranceFromStoreWarehouseStockDetail Item = new EntranceFromStoreWarehouseStockDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new EntranceFromStoreWarehouseStockDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              if(itemCount > 0){ 
                  Item = new EntranceFromStoreWarehouseStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfEntranceFromStoreWarehouseStockDetail", this.getClass());
