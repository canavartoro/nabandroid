...
public class ServiceResponseOfListOfOrder extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfOrder Item = new ArrayOfOrder();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfOrder().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfOrder", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfOrder().register(envelope); 
