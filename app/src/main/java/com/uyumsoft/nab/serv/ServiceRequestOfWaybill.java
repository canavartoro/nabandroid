...
public class ServiceRequestOfWaybill extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public Waybill FilterObject = new Waybill();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new Waybill().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfWaybill", this.getClass());
                   new UserInformation().register(envelope); 
           new Waybill().register(envelope); 
