...
public class File extends BaseObject {
     ...
     public Date FileDate = new Date(1900, 1, 1);
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 2: 
            if(value.toString().equalsIgnoreCase("anyType{}"))
                  FileDate = new Date(1900, 1, 1);
            else 
	                FileDate = DateUtil.getDate(value.toString()); 
                  break; 
           case 3: 
            if(value.toString().equalsIgnoreCase("anyType{}"))
                  CurrentCode = "";
    ...
    {
        envelope.addMapping(NAMESPACE, "File", this.getClass());
