...
public class DispatchOrderStockDetail extends BaseObject {
     ...
     public String Unity = "";
     public BigDecimal DispatchOrderAmount = new BigDecimal(0);
     public BigDecimal SendingAmount = new BigDecimal(0);
    	...
    	switch (index) {
           ...
           case 4: 
                ...
                info.type = PropertyInfo.STRING_CLASS; 
                             break; 
           case 5: 
                info.name = "DispatchOrderAmount"; 
                info.type = BigDecimal.class.getClass(); 
                             break; 
           case 6: 
                info.name = "SendingAmount"; 
                info.type = BigDecimal.class.getClass(); 
                             break; 
           case 7: 
                info.name = "Property1"; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 5: 
            if(value.toString().equalsIgnoreCase("anyType{}"))
                  DispatchOrderAmount = new BigDecimal(0);
            else 
	                DispatchOrderAmount = new BigDecimal(value.toString()); 
                  break; 
           case 6: 
            if(value.toString().equalsIgnoreCase("anyType{}"))
                  SendingAmount = new BigDecimal(0);
            else 
	                SendingAmount = new BigDecimal(value.toString()); 
                  break; 
           case 7: 
            if(value.toString().equalsIgnoreCase("anyType{}"))
                  Property1 = "";
    ...
    {
        envelope.addMapping(NAMESPACE, "DispatchOrderStockDetail", this.getClass());
