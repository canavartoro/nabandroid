...
public class ServiceResponseOfListOfDomesticPurchaseStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfDomesticPurchaseStockDetail Item = new ArrayOfDomesticPurchaseStockDetail();  //array
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  Item = new ArrayOfDomesticPurchaseStockDetail(); 
                  SoapObject prp = (SoapObject)value; 
                  int itemCount = prp.getPropertyCount(); 
                  for(int loop=0;loop<itemCount;loop++){ 
                  if(prp.getProperty(loop) instanceof SoapObject){ 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfDomesticPurchaseStockDetail", this.getClass());
