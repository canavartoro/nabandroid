...
public class ServiceRequestOfListOfLoadingVehicleStockDetail extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public ArrayOfLoadingVehicleStockDetail FilterObject = new ArrayOfLoadingVehicleStockDetail();  //array
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           case 1: 
              if(value != null){ 
                  FilterObject = new ArrayOfLoadingVehicleStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfListOfLoadingVehicleStockDetail", this.getClass());
