...
public class Login extends BaseObject {
    ...
    private static final String NAMESPACE = "http://tempuri.org/";
     ...
     public ServiceRequestOfUser context = new ServiceRequestOfUser();
	...
	public SoapObject GetSoapParams()
	{
		...
		p0.setName("context");
		p0.setValue(context);
		p0.setType(ServiceRequestOfUser.class);
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 0: 
                info.name = "context"; 
                info.type = new ServiceRequestOfUser().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	...
    	{
           case 0: 
                context = (ServiceRequestOfUser)value; 
                  break; 
