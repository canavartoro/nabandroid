...
public class ServiceRequestOfItem extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public Item FilterObject = new Item();
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfItem", this.getClass());
                   new UserInformation().register(envelope); 
           new Item().register(envelope); 
