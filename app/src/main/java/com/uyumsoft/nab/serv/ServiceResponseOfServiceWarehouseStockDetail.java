...
public class ServiceResponseOfServiceWarehouseStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ServiceWarehouseStockDetail Item = new ServiceWarehouseStockDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ServiceWarehouseStockDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              if(itemCount > 0){ 
                  Item = new ServiceWarehouseStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfServiceWarehouseStockDetail", this.getClass());
