...
public class ServiceRequestOfEntranceFromStoreWarehouse extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public EntranceFromStoreWarehouse FilterObject = new EntranceFromStoreWarehouse();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                ...
                info.type = new EntranceFromStoreWarehouse().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              int itemCount = pi.getPropertyCount(); 
              if(itemCount > 0){ 
                  FilterObject = new EntranceFromStoreWarehouse(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfEntranceFromStoreWarehouse", this.getClass());
                   new UserInformation().register(envelope); 
           new EntranceFromStoreWarehouse().register(envelope); 
