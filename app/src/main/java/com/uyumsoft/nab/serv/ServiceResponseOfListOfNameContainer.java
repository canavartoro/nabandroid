...
public class ServiceResponseOfListOfNameContainer extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfNameContainer Item = new ArrayOfNameContainer();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfNameContainer().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfNameContainer", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfNameContainer().register(envelope); 
