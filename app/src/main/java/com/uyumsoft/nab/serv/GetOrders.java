...
public class GetOrders extends BaseObject {

    private static final String METHOD_NAME = "GetOrders";
    private static final String NAMESPACE = "http://tempuri.org/";

     public ServiceRequestOfOrder context = new ServiceRequestOfOrder();
	...
	public SoapObject GetSoapParams()
	{
		...
		p0.setName("context");
		p0.setValue(context);
		p0.setType(ServiceRequestOfOrder.class);
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 0: 
                info.name = "context"; 
                info.type = new ServiceRequestOfOrder().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	...
    	{
           case 0: 
                context = (ServiceRequestOfOrder)value; 
                  break; 
