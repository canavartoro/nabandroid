...
public class ServiceResponseOfLoadingVehicleStockDetail extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public LoadingVehicleStockDetail Item = new LoadingVehicleStockDetail();
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new LoadingVehicleStockDetail().getClass(); 
                             break; 
    ...
    public void setProperty(int index, Object value)
    {
    	switch (index)
    	{
           ...
           if(value != null){ 
              ...
              if(itemCount > 0){ 
                  Item = new LoadingVehicleStockDetail(); 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfLoadingVehicleStockDetail", this.getClass());
