...
public class ServiceRequestOfBill extends BaseObject {

     public UserInformation LoginInformation = new UserInformation();
     public Bill FilterObject = new Bill();
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceRequestOfBill", this.getClass());
                   new UserInformation().register(envelope); 
           new Bill().register(envelope); 
