...
public class ServiceResponseOfListOfGoodsRequest extends BaseObject {

     public ArrayOfString Errors = new ArrayOfString();  //array
     public ArrayOfGoodsRequest Item = new ArrayOfGoodsRequest();  //array
    ...
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) {
    	...
    	switch (index) {
           ...
           case 1: 
                info.name = "Item"; 
                info.type = new ArrayOfGoodsRequest().getClass(); 
                             break; 
    ...
    {
        envelope.addMapping(NAMESPACE, "ServiceResponseOfListOfGoodsRequest", this.getClass());
                   new ArrayOfString().register(envelope); 
           new ArrayOfGoodsRequest().register(envelope); 
